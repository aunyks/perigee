...
const n = {
  ...
  r = {
    ...
    fromHexString(t, i, e = 1) {
      const n = s.fromHexString(t)
      ;(i[0] = (((n >> 16) & 255) / 255) * e),
        (i[1] = (((n >> 8) & 255) / 255) * e),
        (i[2] = ((255 & n) / 255) * e)
    },
    toHexString: ([t, i, e], n = 1) =>
      s.toHexString(
        ((t * (n = 255 / n)) << 16) ^ ((i * n) << 8) ^ ((e * n) << 0)
      ),
  },
  l = {
    isPrimitive: !1,
    ...
    const o = (t) => {
        ...
        if (!l) {
          ...
          ;(r -= i * this._step * this._arrowKeyMultiplier(t)),
            s + r > this._max
              ? (r = this._max - s)
              : s + r < this._min && (r = this._min - s),
            this._snapClampSetValue(s + r)
        }
        n = t.clientY
      },
      a = () => {
...
class g {
  ...
  add(t, e, n, s, r) {
    if (Object(n) === n) return new c(this, t, e, n)
    const l = t[e]
    switch (typeof l) {
      case 'number':
        return new d(this, t, e, n, s, r)
      case 'boolean':
